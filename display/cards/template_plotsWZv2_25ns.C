...
*/
  ...
  md.anConf.addSample( "Tree_TW_0"               , "Single top" ,  kYellow-5);
  md.anConf.addSample( "Tree_TbarW_0"            , "Single top" ,  kYellow-5); 
  md.anConf.addSample( "Tree_TToLeptons_sch_0"   , "Single top" ,  kYellow-5); 
  md.anConf.addSample( "Tree_TToLeptons_tch_0"   , "Single top" ,  kYellow-5); 
  md.anConf.addSample( "Tree_TbarToLeptons_tch_0", "Single top" ,  kYellow-5); 
  ...
  md.anConf.addSample( "Tree_TTHnobb_0"          , "t#bar{t}H"  ,  kOrange+3  );
  md.anConf.addSample( "Tree_TTGJets_0"          , "t#bar{t}#gamma",kMagenta-7 );
