...
#for reg in ${REGS[@]}; do
	...
	#plot=${reg}_${var}
	plot=${var}"WZCR"
	root -l -b -q cards/template_yieldsWZ_50ns.C\(\"${plot}\"\) 
	...
	#mv $DIR/png/${plot}.png   $DIR/WZ3l/${var}.png
	#mv $DIR/pdf/${plot}.pdf   $DIR/WZ3l/${reg}/${var}.pdf
	#mv $DIR/eps/${plot}.eps   $DIR/WZ3l${reg}/${var}.eps
	#mv $DIR/root/${plot}.root $DIR/WZ3l/${var}.root
    done
#done
