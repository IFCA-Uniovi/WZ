...
FakeRatioWZ::FakeRatioWZ(std::string cfg){
  /* 
     constructs the FakeRatioWZ class 
...
//____________________________________________________________________________
FakeRatioWZ::~FakeRatioWZ(){
  /* 
     destructs the FakeRatioWZ class 
     parameters: none
     return: none
  */
...
//____________________________________________________________________________
int FakeRatioWZ::findBin(vector<float> list, float value){
...
//____________________________________________________________________________
vector<vector<vector<string> > > FakeRatioWZ::findTriggerLines(vector<vector<string> > trigger_lines, \
...
//____________________________________________________________________________
vector<float> FakeRatioWZ::findTriggerPts(vector<vector<string> > trigger_lines, string name){
...
//____________________________________________________________________________
void FakeRatioWZ::initialize(){
  /*
    initializes the FakeRatioWZ class
    parameters: none
    return: none
  */
...
//____________________________________________________________________________
void FakeRatioWZ::divideFRMap(string postpend){
...
//  ____________________________________________________________________________
vector<float> FakeRatioWZ::doubleFit(string ext, TH1* h_data, TH1* h_ewk, TH1* h_qcd, float hmin, float hmax){
...
//  ____________________________________________________________________________
void FakeRatioWZ::doubleFit(vector<float>& scales, string ext, TH1* h_data, TH1* h_ewk, TH1* h_qcd, float hmin, float hmax){
...
//____________________________________________________________________________
float FakeRatioWZ::errorProp(float central1, float central2, float error1, float error2){
...
//____________________________________________________________________________
vector<float> FakeRatioWZ::getScalesETH(string obs, float lumi){
...
//____________________________________________________________________________
vector<float> FakeRatioWZ::getScalesUCSX(string obs, float lumi){
...
//____________________________________________________________________________
vector<float> FakeRatioWZ::getScalesUCSXlite(string obs, float lumi){
...
//____________________________________________________________________________
void FakeRatioWZ::modifySkimming(){
...
//  ____________________________________________________________________________
vector<float> FakeRatioWZ::prepareHists(TH1* h_data, TH1* h_ewk, TH1* h_qcd){
...
//____________________________________________________________________________
void FakeRatioWZ::registerLepPlots(vector<string> leps, string var, int nbins, float bmin, float bmax, string axis){
...
//____________________________________________________________________________
void FakeRatioWZ::registerLepPlots(vector<string> leps, string var, int nxbins, vector<float> xbins, string axis){
...
//____________________________________________________________________________
void FakeRatioWZ::registerLepPlots(vector<string> leps, string var, int nxbins, vector<float> xbins, int nybins, vector<float> ybins, string xaxis, string yaxis){
...
//____________________________________________________________________________
void FakeRatioWZ::registerLepVars(){
...
//  ____________________________________________________________________________
void FakeRatioWZ::registerTriggerVars(){
...
//  ____________________________________________________________________________
void FakeRatioWZ::registerVariable(string var, int nBin, float min, float max, string Xleg, bool isglb, bool prof, string type){
...
//  ____________________________________________________________________________
void FakeRatioWZ::registerVariable(string var, int nBinX, float minX, float maxX, int nBinY, float minY, float maxY, string Xleg, string Yleg, bool isglb, bool prof, string type){
...
//  ____________________________________________________________________________
void FakeRatioWZ::registerVariable(string var, int nBinX, vector<float> binsX, string Xleg, bool isglb, bool prof, string type){
...
//  ____________________________________________________________________________
void FakeRatioWZ::registerVariable(string var, int nBinX, vector<float> binsX, int nBinY, vector<float> binsY, string Xleg, string Yleg, bool isglb, bool prof, string type){
...
//  ____________________________________________________________________________
void FakeRatioWZ::setBinErrors(TH1* central, TH1* upper, TH1* lower){
...
//  ____________________________________________________________________________
void FakeRatioWZ::setSystematics(){
...
//  ____________________________________________________________________________
void FakeRatioWZ::setSystError(string obs, string postfix, int idx){
...
//  ____________________________________________________________________________
float FakeRatioWZ::singleFit(string ext, TH1* h_data, TH1* h_mc, float hmin, float hmax){
...
//  ____________________________________________________________________________
void FakeRatioWZ::singleFit(vector<float>& scales, string ext, TH1* h_data, TH1* h_mc, float hmin, float hmax){
...
//  ____________________________________________________________________________
void FakeRatioWZ::subtractEwk(TH1* d, TH1* e, vector<float> scales, string obs, string postfix, int idx){
...
////  ____________________________________________________________________________
//void FakeRatioWZ::subtractEwkStat(TH1* d, TH1* e, vector<float> scales, string obs, string postfix, int idx){
//
//  TH1 * dHI = _hm -> getHisto(obs.substr(0, obs.rfind("_")) + "LO_" + postfix, idx);
//  TH1 * dLO = _hm -> getHisto(obs.substr(0, obs.rfind("_")) + "HI_" + postfix, idx);
//
...
////  ____________________________________________________________________________
//void FakeRatioWZ::subtractEwkSyst(TH1* d, TH1* e, vector<float> scales){
//
//  TH1* dHI = (TH1*) d -> Clone();
//  TH1* dLO = (TH1*) d -> Clone();
//
...
//  ____________________________________________________________________________
void FakeRatioWZ::subtractPlots(string lep, int idx, vector<float> scales, string postfix){
...
//  ____________________________________________________________________________
void FakeRatioWZ::subtractPlotsCERN(string lep, int idx, string postfix){
...
//  ____________________________________________________________________________
void FakeRatioWZ::subtractPromptsCERN(){
...
//____________________________________________________________________________
void FakeRatioWZ::subtractPromptsETH(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::subtractPromptsUCSX(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::sumTriggerPlots(string obs, int ds, string ext){
...
//____________________________________________________________________________
void FakeRatioWZ::collectKinematicObjects(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::collectLeptons(int idx, string branch){
...
//____________________________________________________________________________
bool FakeRatioWZ::denominatorElectronSelection(Candidate* c, int elIdx, string branch){
...
//____________________________________________________________________________
bool FakeRatioWZ::denominatorMuonSelection(Candidate* c, int muIdx, string branch){
...
//____________________________________________________________________________
bool FakeRatioWZ::numeratorElectronSelection(Candidate* c, int elIdx, string branch){
...
//____________________________________________________________________________
bool FakeRatioWZ::numeratorMuonSelection(Candidate* c, int muIdx, string branch){
...
//____________________________________________________________________________
void FakeRatioWZ::setCut(std::string var, float valCut, std::string cType, float upValCut) {
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::setMeasurementRegion() {
  /*
...
//____________________________________________________________________________
bool FakeRatioWZ::baseSelection(){
...
//____________________________________________________________________________
bool FakeRatioWZ::ucsxEwkSelection(){
...
//____________________________________________________________________________
bool FakeRatioWZ::skimSelection(){
...
//____________________________________________________________________________
bool FakeRatioWZ::triggerSelection(){ 
...
//____________________________________________________________________________
bool FakeRatioWZ::triggerSelectionLite(){ 
...
//____________________________________________________________________________
void FakeRatioWZ::fillEventPlots(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::fillEwkEventPlots(){
  /*
    fills the control plots for event quantities
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::fillEwkLepPlots(string prepend, Candidate * lep, int lepIdx, string branch, int wp){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::fillEwkLeptonPlots(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::fillFRMaps(string prepend, Candidate * lep, int lepIdx, string branch, int wp){
...
//____________________________________________________________________________
void FakeRatioWZ::fillFakeRatioMaps(){
  /*
...
//____________________________________________________________________________
void FakeRatioWZ::fillLepPlots(string prepend, Candidate * lep, int lepIdx, string branch, int wp){
  /*
    fills the control plots for leptons PER LEPTON
  */  
...
//____________________________________________________________________________
void FakeRatioWZ::fillLeptonPlots(){
  /*
    fills the control plots for leptons
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::fillQcdEventPlots(){
  /*
    fills the control plots for event quantities
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::fillQcdFakeRatioMaps(){
  /*
    fills the fake ratio maps for leptons
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::fillUcsxEwkEventPlots(){
  /*
    fills the control plots for event quantities
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::fillUcsxEwkLepPlots(string prepend, Candidate * lep, int lepIdx, string branch, int wp){
  /*
    fills the control plots for leptons PER LEPTON
  */  
...
//____________________________________________________________________________
void FakeRatioWZ::fillUcsxEwkLeptonPlots(){
  /*
    fills the control plots for leptons
    parameters: none
    return: none
...
//____________________________________________________________________________
void FakeRatioWZ::findTriggerExts(){
...
//____________________________________________________________________________
void FakeRatioWZ::eventListSyncRA5() {
...
//____________________________________________________________________________
float FakeRatioWZ::overflowPt(float rawPt){
