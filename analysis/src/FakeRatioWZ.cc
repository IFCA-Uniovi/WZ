...
void FakeRatioWZ::initialize(){
  ...
  */
  ...
  _vc->registerVar(_leps + "_jetPtRelv2"           , "AF");
  _vc->registerVar(_leps + "_jetPtRatiov2"         , "AF");
  _vc->registerVar(_leps + "_mvaIdSpring15"        , "AF");
  //_vc->registerVar(_bvar                           , "I" );
...
//____________________________________________________________________________
void FakeRatioWZ::divideFRMap(string kr, string postpend){
...
void FakeRatioWZ::writeOutput(){
  ...
  */
  ...
  //_hm->saveHistos ("FakeRatioWZ", _cfgName);
  //_au->saveNumbers("FakeRatioWZ", _cfgName);
...
//____________________________________________________________________________
bool FakeRatioWZ::goodJetSelection(int jetIdx){
  /*
...
//____________________________________________________________________________
bool FakeRatioWZ::denominatorElectronSelection(int elIdx){
...
//____________________________________________________________________________
bool FakeRatioWZ::denominatorMuonSelection(int muIdx){
...
//____________________________________________________________________________
bool FakeRatioWZ::numeratorElectronSelection(int elIdx){
...
//____________________________________________________________________________
bool FakeRatioWZ::numeratorMuonSelection(int muIdx){
...
//____________________________________________________________________________
bool FakeRatioWZ::vetoElectronSelection(int elIdx){
...
//____________________________________________________________________________
bool FakeRatioWZ::vetoMuonSelection(int muIdx){
...
//____________________________________________________________________________
void FakeRatioWZ::fillFRMaps(string prepend, Candidate * lep, int lepIdx, int wp){
...
//____________________________________________________________________________
void FakeRatioWZ::fillLepPlots(string prepend, Candidate * lep, int lepIdx, int wp){
  /*
  ...
  */  
  ...
  fill(prepend + "PtRel"  ,          _vc->get(_leps + "_jetPtRelv2"  , lepIdx) , _weight);
